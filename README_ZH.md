...
⭐注意！你可以双击`一键更新(update).bat`更新软件，也可以双击`一键启动(start).bat`启动软件。操作系统需要是**windows 10/11、window sever 2025**或者后续版本！

### windows桌面版安装

  👉 [点击下载](https://github.com/heshengtao/super-agent-party/releases/download/v0.3.4/Super-Agent-Party-Setup-0.3.4.exe)

⭐注意！安装时选择仅为当前用户安装，否则启动时需要管理员权限。操作系统需要是**windows 10/11、window sever 2025**或者后续版本！
